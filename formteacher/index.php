...
if (isset($_SESSION['user_id'])) {
	...
	$sql = $db->query("SELECT * FROM staff WHERE id = '$user_id' AND role = 'formteacher' ");
	$data = $sql->fetchArray();
	if ($data) {
...
<html>
<head>
	<title>Form Teachers Portal</title>
				...
				<div class="w3-col m12">
					...
					<div class="w3-row w3-padding-jumbo tt" id="register" style="display: none;">
						...
						<div class="w3-border-bottom w3-border-blue">
							...
							<button class="w3-btn w3-small w3-light-grey bh" data="register_subjects">Register Subjects</button>
							<button class="w3-btn w3-small w3-light-grey bh" data="view_registered_subjects">View Registration</button>
							<button class="w3-btn w3-small w3-light-grey bh" data="marking_template">Download Student Particulars</button> 
						</div><br>
						<div class="hu" id="all">
				        ...
				        <div class="hu" id="marking_template" style="display: none;">
				        	<h5>Download Student Particulars for specific class Using English</h5>
				        	<div class="w3-row">
				        		<div class="w3-col m4 w3-padding w3-border-right">
...
<script type="text/javascript" language="javascript" class="init">
	$(document).ready(function() {
		...
		$('#leftNav').height(innerHeight);
		$('#rightNav').height(innerHeight);
	});
